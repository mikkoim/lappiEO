...
#SBATCH -o "o_iic_inv4.txt"
#SBATCH -e "e_iic_inv4.txt"
...
srun python ../script_load_maastotieto_fnames.py \
    --gdf_fname="../../vectors/buffers/buffer_maastotieto_100m_inv4_train.shp" \
    --tif_folder="$TMPDIR/v3_maastotieto" \
    --label_col='Inventoint' \
    --out_fname="$TMPDIR/train.csv"

srun python ../script_load_maastotieto_fnames.py \
    --gdf_fname="../../vectors/buffers/buffer_maastotieto_100m_inv4_test.shp" \
    --tif_folder="$TMPDIR/v3_maastotieto" \
    --label_col='Inventoint' \
...
srun python ../script_resnet_train.py \
    ...
    --N_classes_source=31 \
    --output_model_name="v3_100m_iic_inv4.pt" \
