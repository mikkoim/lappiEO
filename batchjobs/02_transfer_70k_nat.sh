...
#SBATCH -o "o_trans_70k_nat.txt"
#SBATCH -e "e_trans_70k_nat.txt"
...
singularity run --nv -B $SCRATCH:$SCRATCH -B $TMPDIR:$TMPDIR -H ~ ../lappieo.sif /opt/conda/envs/lappieo/bin/python \
    ../script_resnet_train.py \
        ...
        --pretrained_model="v3_base_corine0_70k.pt" \
        --N_channels_source=14 \
        --N_classes_source=35 \
        --output_model_name="v3_transfer_70k_nat${i}" \
